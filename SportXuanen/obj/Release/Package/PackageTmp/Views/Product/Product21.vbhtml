...
<div id="article">
    <div class="section01" style="margin-top:15%">
        ...
        <img class="mobile_product21_img" src="../images/_product/21/product_01-03.png" style="width:350px; margin-top:5%; margin-left:-40%"><br>
        <div class="section01_txt , mobile_product21_txt" style="display: inline-block; width: 200px; text-align: left; margin-top: -20%; margin-left: 60%">
            <p>儲值會員</p>
            <p>以分鐘計算</p>
            <p>以點數計算</p>
            <p>整合悠遊卡扣款</p>
...
<div id="article2">
    <div class="section02" style="margin-top:5%">
        ...
        <img class="mobile_product21_img" src="../images/_product/21/product_01-09.png" style="width:350px; margin-top:5%; margin-left:-40%"><br>
        <div class="section01_txt , mobile_product21_txt" style="display: inline-block; width: 200px; text-align: left; margin-top: -20%; margin-left: 60%">
            <p>儲值會員</p>
            <p>以分鐘計算</p>
            <p>以點數計算</p>
