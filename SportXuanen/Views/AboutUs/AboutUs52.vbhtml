...
<div id="banner">
    <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-02.png">
    <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-11.png" style="display:flex; width:25%; margin-top:-25%; margin-left:50%">
    <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-12.png" style="display:flex; width:30%; margin-top:2%; margin-left:35%">
</div>
<div id="article">
    <div class="section01" style="height:800px; margin-top:15%; margin-left:auto; margin-right:auto">
        ...
        <div class="mobile_aboutus52_img" style="position: relative; z-index: 1; width:500px; height: 500px; margin-left: auto; margin-right: auto">
            ...
            <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-14.png" style="position:absolute; z-index:3; width:85px; margin-top:265px; margin-left:-115px">
            <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-27.png" style="position:absolute; z-index:2; width:400px; margin-top:310px; margin-left:-300px">
...
<div id="article2">
    <div class="section02" style="height: 600px; margin-top: -15%; margin-left: auto; margin-right: auto">
        <div class="mobile_aboutus52_img"  style="position: relative; z-index: 1; width: 500px; height: 500px; margin-left: auto; margin-right: auto">
            ...
            <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-17.png" style="position:absolute; z-index:4; width:80px; margin-top: 164px; margin-left:25px">
            <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-29.png" style="position:absolute; z-index:3; width:500px; margin-top: 50px; margin-left:-350px">
            <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-21.png" style="position:absolute; z-index:3; width:100px; margin-top: 240px; margin-left:-125px">
            <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-31.png" style="position:absolute; z-index:2; width:480px; margin-top: 145px; margin-left:-175px">
            <img src="../images/_about_us/52/leadership_lyaout_Final_Cut-19.png" style="position:absolute; z-index:2; width:70px; margin-top: 325px; margin-left:55px">
